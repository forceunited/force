...
int nAnonymizeForceAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Force
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Force
    // Mac: ~/Library/Application Support/Force
    // Unix: ~/.Force
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Force";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Force.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Forced.pid"));
