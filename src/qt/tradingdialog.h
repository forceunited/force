...
private slots:
    ...
    QString BuyFOR(QString OrderType, double Quantity, double Rate);
    QString SellFOR(QString OrderType, double Quantity, double Rate);
